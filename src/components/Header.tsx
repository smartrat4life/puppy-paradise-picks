          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex flex-1 max-w-md mx-8">
                <form onSubmit={handleSearch} className="w-full relative" role="search">
                  ...
                  <Button
                    type="submit"
                    size="sm"
                    className="absolute right-1 top-1 bg-teal-600 hover:bg-teal-700 h-8 w-8 p-0"
              ...
              <div className="hidden md:flex items-center gap-4">
                {user && (
                  <span className="text-sm text-white/80" aria-label={`Welcome ${user.email?.split('@')[0]}`}>
            ...
            {/* Mobile Navigation */}
            {isMenuOpen && (
              <nav className="md:hidden mt-4 pb-4 border-t border-white/20 pt-4 bg-black/90 rounded-lg p-4" role="navigation" aria-label="Mobile navigation">
