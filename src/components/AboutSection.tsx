      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card key={feature.title} className="group text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 bg-white border-2 border-amber-200 hover:border-teal-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-amber-700 leading-relaxed mb-6">
                For over 13 years, we've been dedicated to breeding exceptional puppies that become 
                cherished family members. Our passion for dogs and commitment to ethical breeding 
                practices has earned us the trust of countless families.
              </p>
              <p className="text-amber-700 leading-relaxed mb-6">
